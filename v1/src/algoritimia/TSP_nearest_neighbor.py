...
from v1.src.files_management.file_names import product_distances_file, optimized_route_file, pedidos_file
from v1.src.files_management.json_management import load_file, save_file
...
def forced_nearest_neighbor_tsp(product_list, distances):
    ...
    # Remove special nodes from the set to be optimized.
